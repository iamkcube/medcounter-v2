...
export default function MedicineCard({
  ...
  return (
    <Pressable
      onPress={() => router.push(`/medicine/${name}`)}
      className="relative mx-1 mb-3 rounded-xl border border-border bg-card p-4 active:opacity-90"
    >
      <View
      ...
      <View className="pl-3">
        <View className="mb-3 flex-row justify-between">
          <View className="flex-1 flex-row gap-3 items-center">
            ...
            >
              <Pill size={16} className={ACCENT.text} />
            </View>
          ...
          <View className="items-end">
            <View className="flex-row items-center gap-2">
              <View className="flex-row items-center gap-1">
                <View className={`h-1.5 w-1.5 rounded-full ${ACCENT.dot}`} />
